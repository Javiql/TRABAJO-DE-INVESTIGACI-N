...
pos=2
diccionario=[{'nombre':'Javier', 'nota':100},{'nombre':'Arianna','nota':80},{'nombre':'Heidy','nota':90}]
lista=[-2,-2,5,3,40,50]
tupla=(22,23,24,25)
listaClientesDiccionarios=[{'cliente':'Javier','deuda':100},{'cliente':'Arianna','deuda':80},{'cliente':'Heidy','deuda':50}]
